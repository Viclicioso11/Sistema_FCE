...
var calendarEl = document.getElementById('calendarTutor')
...
function verActividad(nombre, descripcion,id, fechaInicio, fechaFin){
	...
	document.getElementById("tituloTarea").value = nombre;
	document.getElementById("descripcionTarea").value = descripcion;
	document.getElementById("fechasTarea").value = fechaInicio + " - " + fechaFin;
