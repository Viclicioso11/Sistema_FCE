	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Edición [Opcion]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="tblopcion.jsp">Gestión Opcion</a></li>
	              <li class="breadcrumb-item active">Edición Opcion</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de Opcion</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form opcione="form" action="../../SL_opcion" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Descripción de Opcion:</label>
