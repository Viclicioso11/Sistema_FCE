        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
             <h2>Gestión de Ámbito</h2>
             
            </div>
            <!-- /.card-header -->
            <div class="card-body" style="overflow-x: scroll">
             <a href="../mantenimiento/newAmbito.jsp">Agregar Ámbito <i class="fas fa-plus-circle"></i></a>
             <br/><br/>
...
function deleteAmbito(idAmbito)
{
	  ...
	  $.jAlert({
		    'type': 'confirm',
		    'confirmQuestion': '¿Está seguro de eliminar el ámbito seleccionado?',
