        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="../mantenimiento/newCarrera.jsp">Agregar Carrera <i class="fas fa-plus-circle"></i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="Tbl_usuario_rol" class="display">
                ...
                <tbody>
                <%
                	DT_carrera dtus = new DT_carrera();
                  	ArrayList<Vw_carrera_facultad> listCarreraFacul = new ArrayList<Vw_carrera_facultad>();
                  	listCarreraFacul = dtus.listCarreraFacul();
                  	        		
                  	for(Vw_carrera_facultad Ucarrera : listCarreraFacul)
                  	{
                %>
	                <tr>
	                  <td><%=Ucarrera.getId_carrera()%> </td>
	                  <td><%=Ucarrera.getNombre_carrera()%></td>
	                  <td><%=Ucarrera.getNombre_facultad() %></td>
	                 
	                  <td>
	                  <a href="#"onclick="EditarCarrera('<%=Ucarrera.getId_carrera()%>');"><i class="fas fa-plus-circle" title="Editar"></i></a>
	                  &nbsp;&nbsp;
	                  <a href="#" onclick="deleteCarrera('<%=Ucarrera.getId_carrera()%>');"><i class="far fa-trash-alt" title="Eliminar"></i> </a>
	                  </td>
	                </tr>
	             <%
	        		}   
...
{
	var idCarrera = carrera;
	window.location.href="../../pages/mantenimiento/editCarrera.jsp?id_carrera="+carrera;	
}
</script>
...
function deleteCarrera(id_carrera)
{
	
	  $.jAlert({
		    'type': 'confirm',
		    'confirmQuestion': '¿Está seguro de eliminar la carrera seleccionada?',
		    'onConfirm': function(e, btn){
		      e.preventDefault();
     		  window.location.href= "../../SL_carrera?opc=1&id_carrera="+id_carrera;
