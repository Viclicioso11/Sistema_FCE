...
<head>
	...
	<title>Edición de Registro Tema FCE</title>
	<!-- Imagen del título-->
	          ...
	          <div class="col-md-12">
	            ...
	            <div class="card card-primary">
	              ...
	              <div class="card-header">
	              	<h3>Edición de Registro de Tema FCE</h3>
	              </div>
              ...
              //aquí se traen los usuarios con sus nombres, apellidos y el id
                ...
                %>
	                <tr>
	                  ...
	                  <td>
	                  <a href="#" onclick="deleteEstudiante('<%=tus.getId()%>');"><i class="far fa-trash-alt" title="Eliminar"></i> </a>
	                  </td>
	                </tr>
	             <%
	        		}   
