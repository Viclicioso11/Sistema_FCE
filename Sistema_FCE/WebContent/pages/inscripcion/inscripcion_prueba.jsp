	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="#">InscripciÛn</a></li>
	              <li class="breadcrumb-item active">InscripciÛn Tema</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
	            ...
	            <div class="card card-primary">
	              ...
	              <form role="form" name="formulario" action="../../SL_prueba_fichero" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						...
						<label for="exampleInputEmail1">Tema de Forma de CulminaciÛn de Estudios:</label>
						<input type="text" id="tema" name="tema" class="form-control" placeholder="Tema de FCE" required>
					
						<br/>
					
						<!-- -->
	                    <label for="exampleInputFile">Propuesta de Forma de CulminaciÛn de Estudios:</label>
						...
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								...
								<ul class="dropdown-menu">
									<li class="dropdown-item"><a data-toggle="modal" data-target="#addMember">AÒadir compa√±ero</a></li>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-header">
			  <h5 class="modal-title" id="exampleModalLabel">Asignaci√≥n estudiante</h5>
