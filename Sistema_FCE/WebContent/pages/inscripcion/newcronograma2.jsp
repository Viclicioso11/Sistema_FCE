...
<head>
  ...
  <title>Crear Cronograma de Actividades</title>
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<!-- 
              ...
              -->
		<!-- /.Creando detalles de cronograma -->
              <div class="card" id="detalle_cronograma">
                <div class="card-header">
                  <h3 class="card-title">Crear Cronograma</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input readonly="readonly"  type="text" class="form-control float-right form-control-sm" id="dateRangeCronograma" required autocomplete="off">
                      </div>
                    </div>

                    <button onclick="guardarCronograma()" type="button" class="btn btn-primary">Guardar</button>
...
<script src="./js/newCronograma.js"></script>
