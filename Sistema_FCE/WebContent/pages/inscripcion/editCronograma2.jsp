...
String idCronograma = "";
idCronograma = request.getParameter("cronogramaID");
...
<head>
  ...
  <title>Editar Cronograma de Actividades</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edición de Cronograma de Actividades</h1>
          </div>
          <div class="col-sm-6">
              ...
              -->
                    ...
                    <div class="form-group">
           				<select onchange="cambiarVista()" class="form-control select2" id="vistas" name="vistas" style="width: 100%;" required="required">
           				  ...
           				  <option value="3">Agregar Actividades</option>
           				</select>
        		</div>
                  ...
                  <form id="addEvent">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="descripcionActividad" class="form-control form-control-sm"></textarea>
						...
						<button type="button" class="btn btn-block btn-primary" onclick="editarActividad()">Editar Actividad</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-block btn btn-danger" onclick="eliminarActividad()">Eliminar Actividad</button>
						
						<input type="hidden" id = "id_actividad_crono" name = "id_actividad_crono">
                  </form>
                </div>
              </div>
              ...
              <div class="card" id="detalle_cronograma">
                ...
                <div class="card-body">
                  ...
                  <form >
					...
					<button type="button" class="btn btn-block btn-primary" onclick="editarCronograma()">Editar Cronograma</button>
                 ...
                 <div class="card" id="agregarActividad">
                <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  <form id="addEvent">
                    ...
                    <div class="form-group">
                      ...
                      <label >Título de la actividad</label>
                      <input id="nombreActividadGuardar" type="text" class="form-control form-control-sm" required autocomplete="off">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control float-right form-control-sm" id="fechaActividadGuardar" required autocomplete="off">
                      </div>
                    </div>

                    <div class="form-group">
                      <label >Descripción de la actividad</label>
                      <textarea id="descripcionActividadGuardar" class="form-control form-control-sm"></textarea>
                    </div>
						<button type="button" class="btn btn-block btn-primary" onclick="agregarActividad()">Guardar Actividad</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button type="reset" class="btn btn-block btn btn-danger" >Cancelar</button>
...
<script>
    $(document).ready(function ()
    {
    	...
    	$("#fecha_inicio_cron").val("<%=tcro.getFecha_inicio()%>");
    	$("#fecha_fin_cron").val("<%=tcro.getFecha_fin()%>");
    	...
    	for(Tbl_actividad_cronograma tacro :listaActividades){
    		...
    		addEvent(descripcion, nombre, fechaInicio, fechaFin, id);
