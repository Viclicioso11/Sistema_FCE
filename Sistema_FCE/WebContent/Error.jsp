    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-danger"></i> ERROR DE ACCESO</h3>

          <p>
            Consulte con el Administrador del Sistema las opciones disponibles para su rol.
            <a href="sistema.jsp">Regrese a la p�gina principal</a>
          </p>
