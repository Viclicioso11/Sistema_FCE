 ...
 */
@WebServlet("/SL_tarea_admin")
public class SL_tarea_admin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SL_tarea_admin() {
        super();
		...
		case 1: 
			...
			if(dtgrut.guardarTareaGrupal(tbtar)) {
				...
				if(dtgrut.asignarTareaGrupo(arregloIdTemas, id_tarea)) {
					...
					response.sendRedirect("./pages/acompanamiento/newtarea_grupal_admin.jsp?msj=1");
				} else {
					
					response.sendRedirect("./pages/acompanamiento/newtarea_grupal_admin.jsp?msj=2");
				}
